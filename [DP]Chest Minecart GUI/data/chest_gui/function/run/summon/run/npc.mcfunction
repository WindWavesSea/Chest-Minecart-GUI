$summon chest_minecart $(x) $(y) $(z) {\
    Tags:["chest_gui","$(name)","down_gui"],\
    Silent:true,\
    Invulnerable:true,\
    NoGravity:1b,\
...
summon chest_minecart ~ ~0.70 ~ \
{\
    Tags:["chest_gui","$(name)","middle_gui"],\
    Silent:true,\
    Invulnerable:true,\
    NoGravity:1b,\
    LootTable:"chest_gui:chest_gui",\
...
$execute positioned $(x) $(y) $(z) run team join minecart @n[type=chest_minecart,tag=chest_gui,tag=middle_gui]

$execute positioned $(x) $(y) $(z) as @n[tag=middle_gui,type=chest_minecart,tag=$(name)] run \
function chest_gui:run/summon/run/add_uuid

$execute positioned $(x) $(y) $(z) run \
summon chest_minecart ~ ~1.40 ~ \
{\
